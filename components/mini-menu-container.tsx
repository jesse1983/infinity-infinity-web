...
export default function MiniMenuContainer({ children, title, noBorder = false }) {
  return (
    <div className="w-full h-[calc(100%_-_64px)] grid grid-cols-12 mt-[64px]">
      ...
      >
        <span className={`mx-[10%] font-light uppercase text-4xl w-1/2 leading-tight ${noBorder ? '' : 'pb-6 border-b-2'}`}>
          {title}
        </span>
      </div>
