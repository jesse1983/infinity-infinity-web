...
export default function MiniMenu({ items = [], maxHeight, marginTop }: { items: ItemNav[], maxHeight?: string, marginTop?: string }) {
  ...
  return (
    <div
      className={`bg-contain absolute px-2 hidden w-[70px] hover:w-[299px] ${height} drop-shadow-2xl z-30 sm:flex flex-col uppercase text-sm font-bold bg-repeat-y bg-right right-0 mr-4  overflow-hidden ${mt}`}
    >
